...
const Logo = memo(() => (
  <div className="flex items-center gap-1 sm:gap-2 cursor-pointer">
    ...
    <span className="font-serif font-bold text-base sm:text-2xl tracking-wide uppercase">
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-orange-600 to-red-600">
        TRENDY
      </span>
          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 h-16 sm:h-20 flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-6">
              <button
                ...
                className="text-black hover:text-gray-600 transition-colors hidden sm:block"
              >
                    ...
                    <div className="relative">
                      {user.photoURL ? (
                        <img
                          src={user.photoURL}
                          alt="User"
                          className="w-8 h-8 sm:w-9 sm:h-9 rounded-full border-2 border-transparent group-hover:border-orange-500 transition-all"
                        />
                      ) : (
              ...
              >
                <div className="flex justify-between items-center mb-12">
                  ...
                  <button
                    ...
                    className="text-gray-500 hover:text-black bg-gray-100 p-2 rounded-full transition-colors"
                  >
                ...
                <div className="flex flex-col gap-6 flex-1 overflow-y-auto">
                  ...
                  >
                    Home
                    <ChevronRight
                      className={`transition-opacity ${currentView === "home" ? "opacity-100 text-orange-600" : "opacity-0 group-hover:opacity-100 text-black"}`}
                    />
                  </motion.button>
                  ...
                  >
                    My Profile
                    <ChevronRight
                      className={`transition-opacity ${currentView === "profile" ? "opacity-100 text-orange-600" : "opacity-0 group-hover:opacity-100 text-black"}`}
                    />
                  </motion.button>
                  ...
                  >
                    Lookbook
                    <ChevronRight
                      className={`transition-opacity ${currentView === "lookbook" ? "opacity-100 text-orange-600" : "opacity-0 group-hover:opacity-100 text-black"}`}
                    />
                  </motion.button>
                  ...
                  {categories.map((item, i) => (
                    ...
                    >
                      {item}
                      <ChevronRight
                        className={`transition-opacity ${currentView === "home" && activeCategory === item ? "opacity-100 text-orange-600" : "opacity-0 group-hover:opacity-100 text-black"}`}
                      />
                    </motion.a>
                  ))}
                  ...
                  {["Customer Service", "Store Locator", "News Letter"].map(
                    (item, i) => (
                      <motion.button
                        initial={{ opacity: 0, x: 20 }}
                        animate={{ opacity: 1, x: 0 }}
                ...
                >
                  {user ? (
                    ...
                    <div className="p-6 bg-orange-50 rounded-3xl border border-orange-100 text-center">
                      ...
                      <p className="text-[10px] text-orange-900/60 leading-relaxed">
                        Early access to summer drops is live. Check your
                        wishlist.
                      </p>
                    </div>
                  )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                {results.map((product) => (
                  ...
                  >
                    ...
                    <h3 className="font-bold text-black group-hover:text-orange-600 transition-colors line-clamp-1">
                      {product.title}
                    </h3>
            ...
            {!query && (
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-4">
                  {["Jacket", "Dress", "Boots", "Watch", "Denim"].map(
                    (term) => (
                      <button
                        key={term}
                        onClick={() => setQuery(term)}
                        className="px-6 py-3 rounded-full border border-gray-200 text-black hover:border-black transition-colors"
                      >
                        {term}
                      </button>
                    ),
...
const ProductModal = memo(
  ({ product, onClose, onAddToCart, onAddToWishlist, wishlist }: any) => {
      ...
      <AnimatePresence>
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-[80] p-2 bg-white/80 backdrop-blur-md rounded-full hover:bg-gray-100 transition-colors"
            >
              <X size={24} />
            </button>
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col">
              <div className="text-sm text-orange-600 font-medium uppercase tracking-widest mb-2">
                {product.subCategory}
              </div>
              ...
              <div className="text-2xl font-sans font-semibold text-black mb-6">
              ...
              <div className="mt-8 pt-8 border-t border-gray-100 flex flex-col gap-6">
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-500">
                  ...
                  <div className="flex items-center gap-2">
                    <Check size={16} className="text-green-500" /> Free Shipping
                  </div>
                  <div className="flex items-center gap-2">
                    <Check size={16} className="text-green-500" /> 30-Day
                    Returns
                  </div>
                  <div className="flex items-center gap-2">
                    <Check size={16} className="text-green-500" /> Secure
                    Checkout
                  </div>
                </div>
                ...
                <div className="p-4 bg-orange-50/50 rounded-2xl border border-orange-100 flex items-center gap-4">
                  ...
                  />
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-orange-900 mb-0.5">
                      Premium Guarantee
                    </p>
                    <p className="text-xs text-orange-800/80 leading-relaxed font-medium">
                      This product is certified for material excellence and
  ...
  return (
    <section className="relative min-h-[calc(100vh-112px)] flex items-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            'url("https://plus.unsplash.com/premium_photo-1683141052679-942eb9e77760?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid lg:grid-cols-2 gap-12 items-center relative z-10 py-20">
        ...
        >
          ...
          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-serif font-bold leading-[0.9] tracking-tight mb-6 text-black">
            DEFINE
            <br />
            <span className="italic font-light text-gray-500">YOUR</span>
            <br />
            REALITY.
          </h1>
          <p className="text-lg text-gray-700 max-w-md mb-8 leading-relaxed font-medium">
            Experience the next generation of premium streetwear. Crafted for
            the bold, designed for the future.
          </p>
          <div className="flex flex-wrap items-center gap-4">
            <button
              type="button"

              className="px-8 py-4 rounded-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold hover:scale-105 transition-transform flex items-center gap-2 shadow-lg shadow-orange-500/20"
            >
...
const ProductCard = memo(
  ({
    ...
    return (
      ...
      >
        <div
          className={`relative aspect-[3/4] rounded-2xl overflow-hidden mb-5 ${isDark ? "bg-zinc-900 border-zinc-800" : "bg-gray-100 border-gray-200"} border shadow-sm group-hover:shadow-2xl transition-all duration-500`}
        >
        ...
        <div className="flex flex-col px-2 pr-1 overflow-hidden">
          <div className="flex justify-between items-center mb-1.5">
            <span
              className={`text-[10px] font-medium uppercase tracking-widest ${isDark ? "text-zinc-500" : "text-gray-500"}`}
            >
              {product.subCategory}
            </span>
            <div
              className={`flex items-center gap-1 px-2 py-0.5 rounded-full ${isDark ? "bg-zinc-900" : "bg-gray-50"}`}
            >
              <Star size={10} className="text-orange-500 fill-orange-500" />
              <span
                className={`text-[10px] font-bold ${isDark ? "text-zinc-300" : "text-black"}`}
              >
                {product.rating}
              </span>
            </div>
          ...
          <div className="flex justify-between items-start gap-4">
            <h3
              className={`text-base font-serif font-bold leading-snug line-clamp-2 transition-colors duration-300 ${isDark ? "text-white group-hover:text-orange-500" : "text-black group-hover:text-orange-600"}`}
            >
              {product.title}
            </h3>
            <span
              className={`text-sm font-sans font-semibold whitespace-nowrap px-2.5 py-1 rounded-lg shadow-sm border ${isDark ? "bg-zinc-800 text-white border-zinc-700" : "bg-white text-black border-gray-200"}`}
            >
              ${product.price.toFixed(2)}
            </span>
          </div>
...
const FeaturedProducts = memo(
  ({
    ...
    const rawProducts = useMemo(
      () =>
        activeCategory
          ? PRODUCT_DATA[activeCategory] || []
          : Object.values(PRODUCT_DATA).flat(),
      [activeCategory],
    );

    // Get unique subcategories for filtering
    const subCategories = useMemo(
      () => ["All", ...new Set(rawProducts.map((p) => p.subCategory))],
      [rawProducts],
    );
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            <div>
              ...
              <p className="text-gray-600 font-medium">
                Curated selections for the modern pioneer.
              </p>
            </div>
...
const TrendingSection = memo(
  ({ onProductClick, onAddToCart, onAddToWishlist, wishlist }: any) => {
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <h2 className="text-gray-400 text-sm uppercase tracking-widest font-bold mb-4">
              Our Story
            </h2>
            <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8 leading-tight">
              Elevating the <span className="text-orange-600">Transit</span> of
              Modern Life.
            </h1>
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              Founded in 2024, Trendytransit was born from a simple observation:
              the modern urban life is a series of transitions. From the morning
              commute to late-night gatherings, we believe your wardrobe should
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  To provide meticulously crafted apparel that combines timeless
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  To become the global standard for high-performance urban
            ...
            <div className="flex items-center gap-6 p-6 bg-gray-50 rounded-2xl border border-gray-100 mb-8">
              ...
              <p className="text-sm text-gray-500">
                <span className="font-bold text-black">50,000+</span> satisfied
                transitters worldwide.
              </p>
            </div>
            ...
            <div className="flex items-start gap-6 p-8 bg-black text-white rounded-3xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  We are proud to be an accredited partner of the International
                  Fashion Council. Our manufacturing processes and design
                  quality are certified for excellence in the global fashion
                  industry.
                </p>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-gray-500">
                Every piece is designed in our London studio with obsession over
                detail.
              </p>
            </motion.div>
          </motion.div>
          ...
          {[
            {
              ...
              desc: "We source the finest materials from sustainable suppliers worldwide.",
              icon: Diamond,
            },
            {
              title: "Modern Functionality",
              desc: "Clothes designed for the way you actually live your life today.",
              icon: ArrowRight,
            },
            {
              title: "Timeless Aesthetic",
              desc: "Style that transcends trends and remains relevant for years.",
              icon: Star,
            },
          ].map((v, i) => (
            <motion.div
    ...
    <div className="max-w-7xl mx-auto px-6">
      <div className="relative rounded-3xl overflow-hidden h-[400px] flex items-center shadow-2xl group cursor-pointer">
        ...
        <div className="relative z-10 p-12 md:p-20 w-full md:w-2/3">
          ...
          <p className="text-white/90 max-w-md mb-8 text-lg">
            Discover pieces that define the modern wardrobe. Uncompromising
            quality meets contemporary design.
          </p>
          <button
            onClick={() => {
              setCurrentView("home");
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="max-h-[70vh] overflow-y-auto pr-4">{content}</div>
      </motion.div>
    </motion.div>,
    document.body,
  );
...
const SUPPORT_SECTIONS: { [key: string]: any } = {
      ...
      <div className="space-y-8">
        <div className="flex gap-4 p-6 bg-gray-50 rounded-2xl">
          ...
          <div>
            ...
            <button className="mt-3 text-orange-600 font-bold text-sm uppercase tracking-widest hover:underline">
              Start Chat
            </button>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-6 border border-gray-100 rounded-2xl flex flex-col gap-3">
            ...
            <p className="text-gray-500 text-sm">
              Find quick answers to common questions about sizes, shipping, and
              more.
            </p>
          </div>
          <div className="p-6 border border-gray-100 rounded-2xl flex flex-col gap-3">
            ...
            <p className="text-gray-500 text-sm">
              Enter your tracking number to see exactly where your transit is.
            </p>
          </div>
        </div>
        <div className="p-6 border border-gray-100 rounded-2xl">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-center gap-2 cursor-pointer hover:text-black transition-colors">
              <ChevronRight size={14} className="text-orange-500" /> My order
              hasn't arrived
            </li>
            <li className="flex items-center gap-2 cursor-pointer hover:text-black transition-colors">
              <ChevronRight size={14} className="text-orange-500" /> I received
              a damaged item
            </li>
            <li className="flex items-center gap-2 cursor-pointer hover:text-black transition-colors">
              <ChevronRight size={14} className="text-orange-500" /> How do I
  ...
  "Store Locator": {
    ...
    render: () => (
      <div className="space-y-6">
        <p className="text-gray-600 uppercase tracking-widest text-xs font-bold">
          Our Flagship Store
        </p>
        ...
        <div className="flex justify-between items-center p-6 bg-gray-50 rounded-2xl">
          <div>
            ...
            <p className="text-gray-500 text-sm">
              42 Streetwear Lane, London, UK
            </p>
          </div>
          <button className="px-4 py-2 bg-black text-white text-xs font-bold rounded-lg hover:bg-gray-800 transition-colors uppercase tracking-widest">
            Directions
          </button>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 border border-gray-100 rounded-2xl space-y-4">
          <h4 className="font-bold flex items-center gap-2 text-black">
            <Check size={18} className="text-green-500" /> Eligible for return
          </h4>
          <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            <img
              src="https://picsum.photos/seed/transit-shoe/100/100"
            ...
            <div className="text-sm">
              ...
              <p className="text-gray-500 mt-1">
                Tags must be attached and items must be in original packaging.
              </p>
            </div>
          </div>
          <p className="text-sm text-gray-600 leading-relaxed">
            We offer a full refund or exchange for any item returned within 30
            days of purchase. Simply generate a return label in your account or
        ...
        <div className="bg-orange-50 p-6 rounded-2xl border border-orange-100">
          ...
          <p className="text-sm text-orange-800">
            Personal items like undergarments and custom-tailored collection
            pieces are not eligible for returns due to hygiene and bespoke
            nature.
          </p>
        </div>
      </div>
    ...
    render: () => (
      <div className="space-y-8">
        <p className="text-gray-600">
          Have a question? Our team is here to help you redefine your transit.
        </p>
        ...
        <div className="pt-6">
          ...
          <div className="flex gap-4">
            {["Instagram", "Twitter", "TikTok"].map((s) => (
              <button
                key={s}
                className="px-4 py-2 bg-gray-100 text-gray-600 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-black hover:text-white transition-all"
              >
                {s}
              </button>
            ))}
      ...
      <div className="space-y-6">
        <div className="p-8 bg-black text-white rounded-3xl relative overflow-hidden">
          ...
          <div className="flex flex-col gap-3">
            ...
            />
            <button className="w-full py-4 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition-colors uppercase tracking-widest">
              Subscribe Now
            </button>
          </div>
...
const Footer = memo(
  ({ setCurrentView, setActiveCategory, onSupportClick }: any) => {
    return (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1">
              ...
              <p className="text-gray-500 max-w-sm leading-relaxed mb-6">
                Elevating everyday transit with premium, crafted apparel and
                accessories. Step into the future of fashion.
              </p>
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 inline-flex items-center gap-4 group hover:border-black transition-all">
                ...
                />
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-black mb-0.5">
                    Certified Excellence
                  </p>
                  <p className="text-[9px] text-gray-500 leading-tight">
                    Accredited Member of Global
                    <br />
                    Fashion Institute 2024
                  </p>
                </div>
              </div>
            </div>
            <div>
              <h4 className="font-bold text-black mb-6 font-sans text-sm tracking-widest uppercase">
                Shop
              </h4>
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-500">
                ...
                <li>
                  <button
                    onClick={() => onSupportClick("Customer Service")}
                    className="hover:text-black transition-colors"
                  >
                    Customer Service
                  </button>
                ...
                <li>
                  <button
                    onClick={() => onSupportClick("Store Locator")}
                    className="hover:text-black transition-colors"
                  >
                    Store Locator
                  </button>
                ...
                <li>
                  <button
                    onClick={() => onSupportClick("Returns")}
                    className="hover:text-black transition-colors"
                  >
                    Returns
                  </button>
                ...
                <li>
                  <button
                    onClick={() => onSupportClick("Contact")}
                    className="hover:text-black transition-colors"
                  >
                    Contact
                  </button>
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mb-6">
                Stay ahead of the curve with our latest drops.
              </p>
              <div className="flex gap-2">
                <input
                  type="email"
...
const ChatbotWidget = memo(() => {
  ...
  >([
    {
      role: "assistant",
      text: "Hey! I'm Toby, your fashion AI assistant. How can I help you today?",
    },
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          text: "I'm currently in training, but I'll be ready to help you with personalized fashion advice soon!",
        },
      ]);
    }, 1000);
  };
...
const LookbookView = ({ onBack }: any) => {
  const lookbookImages = [
    {
      url: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=1020&auto=format&fit=crop",
      title: "Urban Rhythm",
      subtitle: "Summer 2026",
    },
    {
      url: "https://www.next.co.uk/cms/resource/blob/1676428/c1cca7ba6b2508943857bbee41fec07e/brandcampaign-4x5-1-1--data.jpg",
      title: "Midnight Muse",
      subtitle: "Outerwear",
    },
    {
    ...
    {
      url: "https://cdn.mos.cms.futurecdn.net/6LiZmzi5uGGMFBoWP6PydE.jpg",
      title: "Vanguard",
      subtitle: "Avant-Garde",
    },
    {
      url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1mpa7N9dEdsK1JvKG_gs2SbTvkIFCo1w7tw&s",
      title: "Noble Essence",
      subtitle: "Portrait",
    },
    {
      url: "https://s.alicdn.com/@sc04/kf/Hcdbddb3069534d14acaa7ddc483b779ek/European-and-American-Style-Elegant-New-Women-s-Wear-Heavy-Duty-3D-Floral-Solid-Color-Dress-African-Fashion-Sleeveless-Strap-Max.jpg_300x300.jpg",
      title: "Flora & Form",
      subtitle: "Elegant",
    },
    {
      url: "https://i.pinimg.com/736x/4e/1a/49/4e1a49e015307cb28548a4b8c2d5717a.jpg",
      title: "Parisian Chic",
      subtitle: "Editorial",
    },
    {
      url: "https://images.unsplash.com/photo-1532453288672-3a27e9be9efd?q=80&w=464&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      title: "Velvet Hour",
      subtitle: "Luxury",
    },
    {
      url: "https://images.unsplash.com/photo-1686491730848-0c86413833e5?w=300&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGZhc2hpb24lMjB3ZWFyc3xlbnwwfHwwfHx8MA%3D%3D",
      title: "Modern Ethos",
      subtitle: "Minimalist",
    },
    {
      url: "https://images.unsplash.com/photo-1574201635302-388dd92a4c3f?q=80&w=465&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      title: "Saffron Soul",
      subtitle: "Fusion",
    },
    {
      url: "https://plus.unsplash.com/premium_photo-1707932495000-5748b915e4f2?q=80&w=435&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      title: "Luxe Minimal",
      subtitle: "Premium",
    },
    {
      url: "https://u-mercari-images.mercdn.net/photos/m96696865128_1.jpg?width=768&quality=75&_=1764934092",
      title: "Heritage Soul",
      subtitle: "Vintage / 2026",
    },
  ];
    ...
    <div className="max-w-7xl mx-auto px-6 py-20 min-h-screen">
      <div className="flex items-center gap-4 mb-16">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-2 uppercase tracking-widest text-xs font-bold">
            New Collection / 2026
          </p>
        </div>
      </div>
      ...
      <div className="mt-20 p-20 bg-black rounded-[4rem] text-center relative overflow-hidden">
        ...
        >
          <h2 className="text-white text-4xl sm:text-6xl font-serif font-bold mb-6">
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 min-h-screen">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-12">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-black tracking-tight">
            Purchase History
          </h1>
        </div>
      ...
      {orders.length === 0 ? (
        ...
        >
          ...
          <button
            onClick={onBack}
            className="px-8 py-3 bg-black text-white rounded-full font-bold uppercase tracking-widest text-xs hover:bg-orange-600 transition-all shadow-lg active:scale-95"
          >
            Continue Shopping
          </button>
        </motion.div>
                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {order.items.map((item: any, i: number) => (
                        <div
                          key={i}
                          className="flex items-center gap-6 p-4 rounded-3xl bg-gray-50 border border-gray-100 group transition-all"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <h5 className="font-bold text-black truncate mb-1">
                              {item.title}
                            </h5>
                  ...
                  <div className="lg:w-80 flex flex-col gap-6">
                    ...
                    <button className="flex items-center justify-between p-6 rounded-3xl border border-gray-100 hover:border-black transition-all group">
                      <div className="flex items-center gap-3">
                        <RefreshCw
                          size={18}
                          className="text-gray-400 group-hover:text-black group-hover:rotate-180 transition-all duration-500"
                        />
...
const ProfileDashboard = ({
  ...
  const stats = [
    {
      label: "Total Spent",
      value: `$${orders.reduce((acc: number, cur: any) => acc + cur.total, 0).toFixed(0)}`,
      icon: Diamond,
              ...
              <div className="relative mb-4">
                {user.photoURL ? (
                  <img
                    src={user.photoURL}
                    alt="Profile"
                    className="w-24 h-24 rounded-full border-4 border-orange-50 shadow-lg"
                  />
                ) : (
            ...
            <div className="space-y-1">
              {[
                ...
                <button
                  key={item.id}
                  onClick={() =>
                    item.id === "orders" ? onNavigate("orders") : null
                  }
                ...
                >
                  ...
                  <ChevronRight
                    size={14}
                    className={
                      item.id === "overview" ? "text-white/40" : "text-gray-300"
                    }
                  />
                </button>
              ))}
        ...
        <div className="flex-1 space-y-12">
            ...
            <div className="relative z-10">
              <h1 className="text-3xl sm:text-5xl font-serif font-bold text-white mb-4 leading-tight">
                ...
                <span className="italic font-light">
                  {user.displayName?.split(" ")[0] || "Toby"}!
                </span>
              </h1>
              <p className="text-white/80 max-w-md text-sm sm:text-base leading-relaxed mb-8">
                Get ready for the new season. We've handpicked some collections
                just for you based on your unique style.
              </p>
              <button
          ...
          <div className="grid lg:grid-cols-2 gap-8">
              ...
              {orders.length > 0 ? (
                <div className="space-y-4">
                  {orders.slice(0, 2).map((order: any) => (
                    <div
                      key={order.id}
                      className="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:border-black transition-all group"
                    >
            ...
            <div className="p-8 bg-white border border-gray-100 rounded-[40px] shadow-sm flex flex-col items-center text-center">
              ...
              <p className="text-[10px] font-bold text-amber-600 uppercase tracking-[0.2em] mb-2">
                Transit Rewards
              </p>
              ...
              <p className="text-sm text-gray-500 leading-relaxed mb-8 max-w-xs">
                You are 2,400 points away from qualifying for the{" "}
                <span className="font-bold text-black">Gold Tier</span> and free
                express shipping.
              </p>
...
export default function App() {
  ...
  useEffect(() => {
    if (cart.length === 0 && !localStorage.getItem("cart_init_done")) {
      ...
      if (menProducts && menProducts.length > 1) {
        setCart([
          { ...menProducts[0], selectedSize: "M" },
          { ...menProducts[1], selectedSize: "L" },
        ]);
  ...
  const handleProductClick = useCallback(
    (product: any) => setSelectedProduct(product),
    [],
  );
  ...
  const [activeSupportModal, setActiveSupportModal] = useState<string | null>(
    null,
  );
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    if (isSignUp) {
      ...
      const usedPasswords = JSON.parse(
        localStorage.getItem(`pw_history_${email}`) || "[]",
      );
      if (usedPasswords.includes(password)) {
        setAuthError(
          "You have recently used this password. Please choose a new one.",
        );
        return;
      }
    }
    ...
    try {
      if (isSignUp) {
        ...
        localStorage.setItem(
          `pw_history_${email}`,
          JSON.stringify([...new Set([...usedPasswords, password])]),
        );
        ...
        <div className="max-w-md w-full px-6 py-12 bg-white rounded-3xl shadow-xl relative">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M11.0051 28.6006C9.99973 25.6199 9.99973 22.3922 11.0051 19.4115V13.2296H3.03296C-0.371021 20.0012 -0.371021 28.0109 3.03296 34.7825L11.0051 28.6006Z"
                fill="#FBBC05"
              />
              <path
                d="M24.48 9.49932C27.9016 9.44641 31.2086 10.7339 33.6866 13.0973L40.5387 6.24515C36.2058 2.21396 30.4101 -0.0699699 24.48 0.00161733C15.4056 0.00161733 7.10718 5.11644 3.03296 13.2296L11.0051 19.4115C12.901 13.7235 18.2187 9.49932 24.48 9.49932Z"
                fill="#EA4335"
              />
            </svg>
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        backgroundAttachment: "fixed",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <AnimatePresence>{renderAuthModal()}</AnimatePresence>
      ...
      <div className="min-h-screen bg-white/95 backdrop-blur-sm">
        ...
        <Routes>
          ...
          <Route
            path="/lookbook"
            element={<LookbookView onBack={() => setCurrentView("home")} />}
          />
